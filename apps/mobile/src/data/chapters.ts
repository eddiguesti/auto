    ...
    questions: [
      {
        ...
        prompt: 'The countries, the towns, the journeys. How did your family end up where they did?',
        aiHint: 'Start broad: Country and region, then narrow down. Did the family move? Immigrate? Were there stories about the old country?'
      },
      {
        id: 'family-surname',
        question: 'What do you know about your family name?',
        prompt: 'Its origins, its meaning, any stories attached to it.',
        aiHint: 'Simple start: What nationality is the name? Any nicknames? Was the name ever changed? Any famous or infamous relatives who shared it?'
      },
      {
        ...
        aiHint: 'Get the story: Where did they grow up? What were their families like? How did they meet? What was happening in the world when they were young?'
      },
      {
        id: 'grandparents-stories',
        question: 'What stories were passed down about your grandparents?',
        prompt: 'Tales told at the dinner table, legends of the family, things you were always told.',
        aiHint: 'Family lore: What was repeated? Any favourite stories? Any characters or black sheep? Stories about hardship or triumph?'
      },
      {
        id: 'family-trade',
        ...
        aiHint: 'Trace the line: What did grandparents do? Parents? Was there an expectation you would follow? How did it shape the family identity?'
      },
      {
        ...
        aiHint: 'Dig into the culture: Religion? Politics? Work ethic? Manners? What was expected? What was forbidden? Do you still carry those values?'
      },
      {
        id: 'family-heirlooms',
        ...
        aiHint: 'Pick one object: What is it? Where did it come from? Whose was it? What story does it tell? Do you still have it?'
      },
      {
        id: 'world-before-you',
        ...
        aiHint: 'Set the scene: What was happening locally and globally? How did it affect your family? What echoes of that era did you grow up with?'
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        aiHint: 'The full story: How did you find it? What did it cost? First night there? What did you love and hate about it?'
      },
      {
        ...
        aiHint: 'Each home briefly: Where was it? Why did you move there? What do you remember most? Which was your favourite?'
      },
      {
        id: 'favourite-room',
        ...
        aiHint: 'Sensory details: What did it look like? What happened there? Why was it special? Can you still picture it?'
      },
      {
        ...
        aiHint: 'Paint the picture: Who were the characters? What was the corner shop like? Where did you walk? What sounds and smells?'
      },
      {
        id: 'garden-outdoors',
        question: 'Have you had a garden or outdoor space that mattered to you?',
        prompt: 'Growing things, sitting outside, children playing - the life that happened outdoors.',
        aiHint: 'If yes: What did you grow? Where did you sit? What happened out there? How did it change with the seasons?'
      },
      {
        id: 'moving-day',
        question: 'Tell me about a memorable moving day.',
        prompt: 'The chaos, the emotions, the excitement or sadness of leaving one place for another.',
        aiHint: 'Get the story: Where were you going? What did you feel leaving? Any disasters? What was it like arriving?'
      },
      {
        ...
        aiHint: 'Pick one place: What is it? What happened there? Why does it matter? Would you go back?'
      },
      {
        id: 'sense-of-home',
        ...
        aiHint: 'Reflective: What do you need around you to feel at home? Has that changed over time? Where do you feel most at home right now?'
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        aiHint: 'Through the ages: Christmas as a child vs as a parent vs now. What stayed the same? What changed? Best Christmas ever?'
      },
      {
        ...
        aiHint: 'Specific memories: A birthday that stands out? The cake? The presents? Who was there? How did you celebrate your children\'s birthdays?'
      },
      {
        id: 'sunday-rituals',
        ...
        aiHint: 'Walk through the day: Morning routine? Church? The meal? Afternoon activities? How have Sundays changed over your lifetime?'
      },
      {
        id: 'wedding-funerals',
        ...
        aiHint: 'Pick one event: Whose was it? What happened? What do you remember most? How did it affect you?'
      },
      {
        ...
        aiHint: 'Pick one: What was the tradition? Who was involved? What did you do? Do you still keep it up?'
      },
      {
        id: 'family-recipes',
        ...
        aiHint: 'Pick one dish: What is it? Who made it best? Can you describe the taste and smell? Have you taught anyone to make it?'
      },
      {
        id: 'family-sayings',
        ...
        aiHint: 'Get specific: What was the saying? Who said it? When? Does anyone still say it? What did it really mean?'
      },
      {
        id: 'new-traditions',
        ...
        aiHint: 'Pick one: How did it start? What exactly happens? What does it mean to you? Do your children or grandchildren keep it going?'
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        aiHint: 'Full story: How old were you? Who took you? The journey, the arrival, the excitement. What stands out most?'
      },
      {
        ...
        aiHint: 'Sensory details: What did you see? The colours, the light, the sounds. Why did it affect you so deeply? Would you go back?'
      },
      {
        ...
        aiHint: 'Pick one holiday: Where did you go? How did you get there? What went wrong? What went right? A moment you all still talk about?'
      },
      {
        id: 'adventure-story',
        question: 'Have you ever had a real adventure?',
        prompt: 'Something unexpected, thrilling, or completely out of your comfort zone.',
        aiHint: 'Get the full story: What happened? Were you scared? Who was with you? How did it change you?'
      },
      {
        ...
        aiHint: 'The encounter: Where were you? Who were they? What happened? Did you stay in touch?'
      },
      {
        ...
        aiHint: 'Why that place? What drew you to it? What stopped you going? Do you still think about it?'
      },
      {
        id: 'travel-disasters',
        question: 'Tell me about a holiday that went wrong.',
        prompt: 'The funny disasters, the lost luggage, the wrong turns that became the best stories.',
        aiHint: 'Get the story with humour: What happened? How bad was it at the time? How funny is it now? What did you learn?'
      },
      {
        id: 'travel-lessons',
        ...
        aiHint: 'Reflective: What surprised you about other cultures? What did you learn about yourself? How did travel broaden your view?'
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        aiHint: 'Let them choose: What was it? How did it begin? What was the worst moment? How did you get through it? What did it teach you?'
      },
      {
        ...
        aiHint: 'Handle sensitively: What happened? How did you find out? Who supported you? How did it change the way you live?'
      },
      {
        ...
        aiHint: 'Real stories: What was the situation? What did you go without? How did you cope? Any resourcefulness or creativity?'
      },
      {
        id: 'loss-grief',
        question: 'How have you dealt with loss and grief?',
        prompt: 'Losing people you loved, learning to carry on, finding a way through.',
        aiHint: 'With great care: Who did you lose? How did it affect you? What helped? How do you carry their memory?'
      },
      {
        id: 'failure-setback',
        question: 'Tell me about a time things went badly wrong.',
        prompt: 'A failure, a mistake, a setback that knocked you sideways.',
        aiHint: 'The full arc: What happened? How did you feel? What did you do? How did you recover? What did you learn?'
      },
      {
        ...
        aiHint: 'Personal and honest: What do you draw on? Has it always been the same? A specific moment when you found inner strength you didn\'t know you had?'
      },
      {
        id: 'helping-others',
        ...
        aiHint: 'The story: Who was it? What happened? What did you do? How did it affect your relationship? What did it teach you?'
      },
      {
        id: 'silver-linings',
        question: 'Has anything good ever come from a difficult experience?',
        prompt: 'Unexpected gifts from hard times - new perspectives, stronger relationships, personal growth.',
        aiHint: 'Positive reflection: What was the difficulty? What good came from it? How long did it take to see the silver lining?'
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        aiHint: 'Deeply personal: What do you want them to know? What are you grateful for? A memory that captures your love? Words you wish you said more often?'
      },
      {
        id: 'letter-to-children',
        question: 'What do you want your children to know?',
        prompt: 'The things you hope they understand about you, about life, about how much they matter.',
        aiHint: 'From the heart: What are you proud of in them? What do you hope for them? What do you want them to remember about you? Any apologies or explanations?'
      },
      {
        id: 'letter-to-grandchildren',
        question: 'What message would you leave for your grandchildren?',
        prompt: 'Words they might read in years to come. What should they know about you and about life?',
        aiHint: 'Legacy writing: What do you want them to know about your life? About the family? Advice for their future? What you hope for them?'
      },
      {
        ...
        aiHint: 'Honest and tender: What would you warn them about? What would you reassure them about? What would you tell them to enjoy more?'
      },
      {
        id: 'letter-to-lost',
        ...
        aiHint: 'Handle with great care: Who is it? What would you say? What do you wish you had told them? What do you want them to know?'
      },
      {
        id: 'letter-to-friend',
        ...
        aiHint: 'Warm and personal: What has the friendship meant? A favourite memory together? What do you admire about them? What would you thank them for?'
      },
      {
        id: 'letter-to-future',
        question: 'What would you write to someone reading this book in 50 years?',
        prompt: 'A message to a great-grandchild or a stranger. What should they know about your time?',
        aiHint: 'Big picture: What was life like? What mattered? What do you hope the world looks like for them? What wisdom transcends the years?'
      },
      {
        id: 'final-letter',
...
// Helper to get question by chapter and question ID
export function getQuestion(chapterId: string, questionId: string): Question | undefined {
  const chapter = getChapterById(chapterId);
  return chapter?.questions.find(q => q.id === questionId);
}
