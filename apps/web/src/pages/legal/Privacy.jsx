        ...
        <div className="prose prose-sepia max-w-none space-y-8">
          <section>
            ...
            <p className="text-warmgray leading-relaxed">
              Easy Memoir ("we", "our", "us") is committed to protecting your privacy. This Privacy
              Policy explains how we collect, use, and safeguard your personal information when you
              use our autobiography writing service.
            </p>
            <p className="text-warmgray leading-relaxed mt-4">
              We understand that the stories you share are deeply personal. We treat your data with
              the utmost respect and security.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-warmgray space-y-1">
              ...
              <li>
                <strong>Profile Information:</strong> Birth year (optional)
              </li>
              <li>
                <strong>Story Content:</strong> Your written stories, memories, and answers to
                prompts
              </li>
              <li>
                <strong>Voice Recordings:</strong> Audio from voice interviews (processed in
                real-time, not stored)
              </li>
              <li>
                <strong>Photos:</strong> Images you upload to accompany your stories
              </li>
              <li>
                <strong>Payment Information:</strong> Processed securely by our payment partners
              </li>
            </ul>
          ...
          <section>
            ...
            <p className="text-warmgray leading-relaxed">
              <strong>Important:</strong> Your stories are processed by AI solely to provide the
              Service to you.
            </p>
            <ul className="list-disc list-inside text-warmgray mt-2 space-y-1">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-warmgray mt-2 space-y-1">
              <li>
                <strong>AI Service Providers:</strong> xAI (Grok) for story processing
              </li>
              <li>
                <strong>Printing Partners:</strong> Lulu for book printing (only when you order)
              </li>
              <li>
                <strong>Authentication:</strong> Google (if you use Google Sign-In)
              </li>
              <li>
                <strong>Hosting:</strong> Railway/secure cloud infrastructure
              </li>
              <li>
          ...
          <section>
            ...
            <p className="text-warmgray">
              Required for the website to function. These include authentication tokens and session
              management.
            </p>
          ...
          <section>
            ...
            <p className="text-warmgray leading-relaxed">
              Easy Memoir is not intended for children under 16. We do not knowingly collect data
          ...
          <section>
            ...
            <p className="text-warmgray leading-relaxed">
              Your data may be processed in countries outside the UK/EEA. We ensure appropriate
          ...
          <section>
            ...
            <p className="text-warmgray leading-relaxed">
              ...
              changes via email or through the Service. The date at the top indicates the last
              update.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-warmgray mt-2">
              ...
              <br />
              Data Protection Officer: dpo@easymemoir.co.uk
              <br />
              Easy Memoir Ltd
              <br />
              United Kingdom
            ...
            <p className="text-warmgray mt-4">
              ...
              Office (ICO) if you believe your rights have been violated.
            </p>
          </section>
        </div>
