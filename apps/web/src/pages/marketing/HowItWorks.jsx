    ...
    <div className="min-h-screen bg-cream">
      ...
      <section className="py-16 px-6 bg-gradient-to-b from-cream to-white">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="font-display text-4xl sm:text-5xl text-ink mb-6">How Easy Memoir Works</h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 text-sepia mb-4">
                <span className="w-8 h-8 rounded-full bg-sepia text-white flex items-center justify-center font-display">
                  1
                </span>
              ...
              <p className="font-serif text-lg text-warmgray leading-relaxed mb-6">
                Start a voice conversation with our AI interviewer. It's like chatting with a caring
                friend who genuinely wants to hear your stories.
              </p>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-warmgray text-sm">
                      AI asks questions that unlock forgotten memories
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-warmgray text-sm">
                      7 life chapters with 40+ thoughtful questions
                    </p>
                  </div>
                </li>
              </ul>
            ...
            <div className="bg-parchment rounded-3xl p-8 shadow-lg">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-full bg-sepia/20 flex items-center justify-center text-sm">
                  AI
                </div>
              ...
              <div className="flex items-center gap-3 justify-end mb-6">
                <div className="bg-sepia/10 rounded-2xl p-4 max-w-[80%]">
                  <p className="font-serif text-ink">
                    Oh, the farmhouse on Maple Street! The kitchen always smelled like fresh
                    bread...
                  </p>
                </div>
                <div className="w-10 h-10 rounded-full bg-ink/10 flex items-center justify-center text-sm">
                  You
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="font-serif text-lg text-warmgray leading-relaxed mb-6">
                ...
                unique voice, vocabulary, and personality - the final text sounds like you, not a
                robot.
              </p>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-warmgray text-sm">
                      Enriches your stories with sensory descriptions
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-warmgray text-sm">
                      Beautifully formatted, ready to print at home
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-warmgray text-sm">
                      Hardcover, paperback, or spiral-bound options
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-warmgray text-sm">
                      Add images to bring your stories to life
                    </p>
                  </div>
                </li>
              </ul>
                ...
                icon: (
                  ...
                  >
                    ...
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth={1.5}
                      d="M12 12c-4 0-7 2.5-7 5.5V19h14v-1.5c0-3-3-5.5-7-5.5z"
                    />
                  </svg>
                )
              },
      ...
      <section className="py-20 px-6 bg-cream">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="font-serif text-lg text-warmgray mb-8">
            Join thousands of people preserving their memories for future generations. Free to
      ...
      <footer className="py-12 px-6 border-t border-sepia/10 bg-white">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-6 text-sm text-warmgray">
            <Link to="/privacy" className="hover:text-sepia transition">
              Privacy
            </Link>
            <Link to="/terms" className="hover:text-sepia transition">
              Terms
            </Link>
            <Link to="/cookies" className="hover:text-sepia transition">
              Cookies
            </Link>
          </div>
        </div>
