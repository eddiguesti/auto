...
export default function VoiceChat() {
  ...
  const advanceToNextQuestionRef = useRef(null)
  ...
  // Keep conversationHistory ref in sync with state
  useEffect(() => {
    conversationHistoryRef.current = conversationHistory
  }, [conversationHistory])

  // Save current question transcript — reads from ref to avoid stale closures
        ...
        switch (data.type) {
          ...
          case 'response.output_audio_transcript.done':
            if (currentAiTranscriptRef.current) {
              ...
              // Detect topic transitions — use ref to always call latest version
              const transitionPhrases = [
                ...
                'now, tell me',
                "that's great. now",
                "that's really helpful, thank you. now",
                "that's really helpful. now",
                'lovely. now',
              ...
              if (isTransition) {
                // Auto-advance — use ref to avoid stale closure
