...
export default function ExportModal({ onClose, userName }) {
  ...
  const startRecording = async () => {
    ...
    try {
      ...
      // If stream was acquired before the error, stop its tracks
      if (stream) {
        stream.getTracks().forEach(track => track.stop())
      }
  ...
  if (showBookOrder) {
    return (
      <BookOrderWizard userName={userName} pageCount={50} onClose={() => setShowBookOrder(false)} />
    )
  }
    ...
    >
      ...
      >
        ...
        <div className="p-6 grid sm:grid-cols-2 gap-4">
          {/* Style Your Memoir */}
          <div
            className={`bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-5 border-2 border-amber-200 hover:border-amber-300 hover:shadow-lg transition-all duration-300 group cursor-pointer transform hover:-translate-y-1 ${
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <svg
                    className="w-5 h-5 text-amber-600 group-hover:translate-x-1 transition"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          {/* eBook Export */}
          <div
            className={`bg-white rounded-2xl p-5 border border-stone-200 hover:border-sepia/50 hover:shadow-lg transition-all duration-300 group cursor-pointer transform hover:-translate-y-1 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <svg
                    className="w-5 h-5 text-sepia group-hover:translate-x-1 transition"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          {/* Printed Book */}
          <div
            className={`bg-gradient-to-br from-stone-800 to-stone-900 text-white rounded-2xl p-5 hover:shadow-2xl transition-all duration-300 group cursor-pointer relative overflow-hidden transform hover:-translate-y-1 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <svg
                    className="w-5 h-5 text-white/70 group-hover:translate-x-1 transition"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
          ...
          {/* Audiobook */}
          <div
            className={`bg-gradient-to-br from-purple-50 to-indigo-50 rounded-2xl p-5 border border-purple-200 hover:border-purple-300 hover:shadow-lg transition-all duration-300 group transform hover:-translate-y-1 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
        ...
        <div className="px-6 pb-6">
          <div className="text-center text-xs text-warmgray/60 border-t border-stone-200 pt-4">
            <p>
              All exports include your complete memoir with {exportStatus?.storyCount || 0} stories
            </p>
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center z-[60] p-4">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-xl">
            ...
            <p className="text-sm text-warmgray mb-4">
              Record a 15-30 second voice sample. Our AI will learn your voice and narrate your
              entire memoir.
            </p>
            ...
            <label className="flex items-start gap-3 mb-6 p-3 bg-amber-50 rounded-lg border border-amber-200">
              ...
              <span className="text-sm text-amber-900">
                I consent to having my voice cloned using AI. I can delete my voice model at any
                time.
              </span>
            </label>
