// Blog post data — extracted from BlogPost.jsx for bundle optimization
export const blogPostsData = {
  'how-to-write-memoir-complete-guide': {
    id: 1,
    title: 'How to Write a Memoir: The Complete 2026 Guide',
    subtitle:
      'Everything you need to know about transforming your life experiences into a compelling narrative',
    excerpt:
      'A comprehensive guide covering everything from finding your theme to publishing your finished memoir.',
  ...
  'therapeutic-benefits-writing-life-story': {
    ...
    excerpt:
      'Discover the scientifically-proven therapeutic benefits of writing about your life experiences.',
  ...
  'interview-parents-grandparents-guide': {
    ...
    excerpt:
      "A step-by-step guide to conducting meaningful interviews that preserve your family's stories.",
  ...
  'memoir-structure-outline-guide': {
    ...
    excerpt:
      'Learn different structural approaches and find the one that works best for your story.',
  ...
  'legacy-letters-alternative-memoir': {
    ...
    excerpt:
      "Sometimes the best way to preserve your wisdom is to write directly to those who'll come after you.",
    date: 'January 7, 2026',
  ...
  'memoir-questions-family-ask': {
    ...
    excerpt:
      "The right questions can open doors to stories your family members didn't know they had.",
    date: 'January 6, 2026',
    category: 'Family',
