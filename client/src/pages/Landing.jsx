...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-cream overflow-x-hidden">
      ...
      {/* Early Adopter - Sticky banner with glow effect */}
      <section className="relative py-8 overflow-hidden">
        {/* Glow background */}
        <div className="absolute inset-0 bg-gradient-to-r from-amber-100/50 via-orange-100/30 to-amber-100/50" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-amber-200/30 via-transparent to-transparent" />

        <div className="relative max-w-lg mx-auto px-6">
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-6 shadow-xl shadow-amber-900/10 border border-amber-200/50">
            <div className="flex items-center gap-4">
              {/* Animated gift icon */}
              <div className="w-14 h-14 bg-gradient-to-br from-amber-400 to-orange-500 rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg shadow-orange-500/30 animate-[pulse-soft_2s_ease-in-out_infinite]">
              ...
              <div>
                <p className="font-display text-lg text-ink leading-snug">
                  First <span className="font-semibold text-orange-600">100</span> users get their memoir
                  <span className="italic text-sepia"> completely free</span>
                </p>
                <p className="font-sans text-xs text-warmgray mt-1">
                  Be an early adopter · Limited spots remaining
                </p>
              </div>
            </div>
          </div>
