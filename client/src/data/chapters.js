    ...
    questions: [
      {
        ...
        aiHint: "Focus on sensory details and emotions"
      },
      {
        id: 'childhood-home',
        question: "What did your childhood home look like?",
        prompt: "Walk me through the front door. What would I see, smell, hear?",
        aiHint: "Ask about specific rooms, furniture, or family gathering spots"
      },
      {
        id: 'important-people',
        question: "Who were the important people around you?",
        prompt: "Describe one person who made you feel safe and loved.",
        aiHint: "Explore their personality, what they looked like, how they made you feel"
      },
      {
        id: 'early-smells-sounds',
        question: "What smells or sounds remind you of that time?",
        prompt: "Think about cooking, music, voices, the outdoors...",
        aiHint: "Connect these sensory memories to specific moments or people"
      },
      {
        ...
        aiHint: "Ask about the emotional attachment and any stories connected to it"
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        aiHint: "Ask about specific games, rules they invented, or memorable matches"
      },
      {
        id: 'summer-holidays',
        question: "Describe a typical day during summer holidays.",
        prompt: "From when you woke up to when you went to bed - what filled your days?",
        aiHint: "Explore the freedom, adventures, or routines of childhood summers"
      },
      {
        id: 'mischief',
        question: "What got you into trouble?",
        prompt: "Tell me about a time you were mischievous. Did you get caught?",
        aiHint: "Ask about the consequences and what they learned from it"
      },
      {
        ...
        aiHint: "Explore how these fears or excitements shaped them"
      },
      {
        id: 'best-friend',
        question: "Who was your best friend?",
        prompt: "What adventures did you have together? Are you still in touch?",
        aiHint: "Ask about specific memories and what made that friendship special"
      },
      {
        ...
        aiHint: "Ask who started the tradition and if they've passed it on"
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        aiHint: "Ask about specific details - the classroom, teacher, other children"
      },
      {
        ...
        aiHint: "Explore how this teacher influenced their path"
      },
      {
        id: 'subjects',
        ...
        aiHint: "Ask how these preferences shaped their career or interests"
      },
      {
        id: 'school-friend',
        question: "Tell me about a school friend.",
        prompt: "What did you do together? Any memorable moments?",
        aiHint: "Ask about the dynamic of the friendship and what they admired in each other"
      },
      {
        id: 'future-dreams',
        question: "What did you want to be when you grew up?",
        prompt: "What sparked that dream? Did it change over time?",
        aiHint: "Ask how close their life came to that childhood dream"
      },
      {
        ...
        aiHint: "Ask who shared in that moment of pride with them"
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        aiHint: "Ask about specific bands, fashion choices, or cultural moments"
      },
      {
        id: 'first-romance',
        question: "Tell me about your first crush or first date.",
        prompt: "What were they like? What happened? How did you feel?",
        aiHint: "Ask about the nervous excitement and what they remember most"
      },
      {
        id: 'parents-teen',
        ...
        aiHint: "Explore both the tensions and the support during these formative years"
      },
      {
        id: 'teen-ambition',
        question: "What was your biggest dream or ambition?",
        prompt: "What did you believe was possible? What were you striving for?",
        aiHint: "Ask what drove that ambition and who supported it"
      },
      {
        ...
        aiHint: "Explore the before and after of this realization"
      },
      {
        id: 'teen-rebellion',
        question: "Did you ever rebel? Push boundaries?",
        prompt: "What did you do? How did it turn out?",
        aiHint: "Ask what they were rebelling against and what they learned"
      }
    ]
  },
  {
    ...
    questions: [
      {
        ...
        aiHint: "Ask about first impressions, early dates, and when they knew"
      },
      {
        id: 'first-job',
        question: "What was your first real job?",
        prompt: "How did you get it? What did you learn? What do you remember most?",
        aiHint: "Ask about the people, challenges, and growth from this experience"
      },
      {
        ...
        aiHint: "Ask about the neighbourhood, flatmates, or independence"
      },
      {
        id: 'life-decisions',
        ...
        aiHint: "Ask about what influenced these decisions and any second thoughts"
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        aiHint: "Ask what got them through and what they learned about themselves"
      },
      {
        ...
        aiHint: "Ask how these traditions started and what they mean"
      },
      {
        ...
        aiHint: "Ask what it taught them about their children and themselves"
      },
      {
        id: 'career-lessons',
        question: "What did your career teach you about life?",
        prompt: "Beyond the job itself - what wisdom came from your working years?",
        aiHint: "Ask about mentors, mistakes that became lessons, and growth"
      }
    ]
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        aiHint: "Ask what they hope their legacy of wisdom will be"
      },
      {
        id: 'how-remembered',
        question: "How do you want to be remembered?",
        prompt: "When people speak of you, what do you hope they say?",
        aiHint: "Ask what they're doing now to live up to that vision"
      },
      {
        ...
        aiHint: "Ask how these surprises changed their perspective"
      },
      {
        id: 'gratitude',
        question: "What are you most grateful for?",
        prompt: "People, experiences, moments - what fills you with gratitude?",
        aiHint: "Ask them to speak to these people or moments directly"
      }
    ]
  }
];
