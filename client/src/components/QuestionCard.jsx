      ...
      <div className="p-6">
        <div className="relative">
          <textarea
            ...
            className="w-full h-64 p-4 border border-gray-200 rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-sepia/30 focus:border-sepia text-ink leading-relaxed"
          />
          {saving && (
        ...
        <div className="mt-4 flex flex-wrap gap-3">
          ...
          <label
            ...
            className={`inline-flex items-center gap-2 px-4 py-2 border border-sepia/30 text-sepia rounded-lg hover:bg-sepia/5 transition cursor-pointer ${
          ...
          {!storyId && answer.trim() && (
            <span className="text-xs text-sepia/50 self-center">
          ...
          <button
            onClick={onAskAI}
            className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-lg hover:from-purple-600 hover:to-indigo-600 transition"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
